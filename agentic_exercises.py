 ...
 "cells": [
  {
   ...
   "metadata": {},
   "source": [
    "# Agentic Patterns: Practice Exercises Solutions\n",
    "\n",
    "**Exercises:**\n",
    "1. Adaptive Reflection with Quality Metrics\n",
    "2. Plan-Execute + Reflection Hybrid\n",
    "\n",
    "---"
   ]
  },
  ...
  },
  {
   ...
   "source": [
    ...
    "!pip install -q langgraph langchain langchain-openai python-dotenv matplotlib"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "Combine Plan-Execute and Reflection patterns for high-quality multi-step tasks."
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    ...
    "    \n",
    "    print(f\"\\n⚙️ EXECUTING STEP {state['current_step'] + 1}:\")\n",
    ...
    "        print(\"\\n✍️ GENERATING INITIAL DRAFT FROM RESULTS...\")\n",
    "    else:\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "        print(f\"   ⚠️ Max reflection iterations ({MAX_REFLECTIONS}) reached\\n\")\n",
    "        return \"finalizer\"\n",
    "    \n",
    "    return \"generator\"\n",
    "\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "## Summary\n",
    "\n",
    "### Exercise 1: Adaptive Reflection\n",
    "- ✅ Implemented structured quality scoring with Pydantic\n",
    "- ✅ Tracks 3 metrics: Clarity, Completeness, Accuracy\n",
    "- ✅ Refines only when scores < 4\n",
    "- ✅ Visualizes score progression\n",
    "\n",
    "### Exercise 2: Hybrid Pattern\n",
    "- ✅ Combined Plan-Execute and Reflection patterns\n",
    "- ✅ Plans steps upfront\n",
    "- ✅ Executes all steps\n",
    "- ✅ Generates draft from results\n",
    "- ✅ Critiques and refines output\n",
    "- ✅ Produces high-quality final result\n",
    "\n",
    "### Key Insights\n",
    "1. **Structured outputs** (Pydantic) enable precise control over agent behavior\n",
    "2. **Patterns can be combined** to leverage strengths of each\n",
    "3. **Multi-stage processing** (Plan → Execute → Reflect) produces higher quality results\n",
    "4. **Visualization** helps understand agent behavior and improvements\n\n**🎉 Exercises Complete!**"
   ]
  }
 ],
 "metadata": {
